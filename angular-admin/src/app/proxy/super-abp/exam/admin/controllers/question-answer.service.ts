...
export class QuestionAnswerService {
  ...
  getList = (input: GetQuestionAnswersInput) => {
    return this.restService.request<any, PagedResultDto<QuestionAnswerListDto>>(
      {
        method: 'GET',
        url: '/api/question-management/question-answer',
