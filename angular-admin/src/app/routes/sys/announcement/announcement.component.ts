...
export class SysAnnouncementComponent implements OnInit {
  ...
  columns: STColumn[] = [
    ...
    { title: this.localizationService.instant('Exam::ScheduledPublishTime'), index: 'scheduledPublishTime', type: 'date' },
    { title: this.localizationService.instant('Exam::ScheduledExpirationTime'), index: 'scheduledExpirationTime', type: 'date' },
